...
ENtemp2 = xar.open_mfdataset(glob.glob('ENtemp_NoInterp*NoFMoor_OCCIPUT.nc')[0]).isel(depth=[0,1,2,3,4,5])
...
# Robs file is saved
Robs.rename('POTM_ERR').to_netcdf('Robs_TEMP_OCCIPUT_RemovalAnomaly.nc','w')
